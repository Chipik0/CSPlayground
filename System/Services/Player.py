...
class PlaybackManager(QObject):
    ...
    def process_audio_chunk(self, frames: int) -> numpy.ndarray:
        ...
        if ctx["do_mid"] and self.filter_states is not None:
    ...
    def set_midpass(
        ...
        self.loom.set_target_value("midpass_mix",  0.0, duration_ms, easing)
        self.loom.set_target_value("midpass_gain", 0.0, duration_ms, easing)
