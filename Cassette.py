...
class StartupFadeOverlay(QWidget):
    ...
    def start(self, default_hold_ms=600):
        ...
        if is_first_start:
            ...
            if not egg:
                Player.ui_player.play_sound("App/Startup", enable_tone_randomizer = False)
...
class ApplicationWindow(QMainWindow):
    ...
    def initiate_shutdown(self):
        ...
        content = self.compositor_widget.content_widget
        mult = CURRENT_SETTINGS.get("animation_multiplier", 1.0)
        ...
        if Player.player.is_playing and content.global_waveform_max > 1e-6:
            ...
            QTimer.singleShot(close_vis_timeout + 1500, self.final_close)
